...
public class Winchy extends Subsystem {
	...
	private DigitalInput lowLimit = new DigitalInput(CompRobotMap.lowLimit);
	//private DigitalInput highLimit = new DigitalInput(1);
	private DigitalInput servoSwitch = new DigitalInput(CompRobotMap.servoSwitch);
